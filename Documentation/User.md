...
2. If your provider account was successful in its creation, you will see this page.
...
2. Fill out the title and description of the course. Optionally, you can add a course identifier, a start date, and an end date.
...
4. ![Complete Confirm Button](<../Auxiliary Files/Images/User_Images/commitment-complete-confirm.png>)
...
1. This brings up a modal asking you to confirm. Click the *DELETE* button to confirm deletion.
...
1. Share with others. They will be able to see the details of the commitment but
not alter it.
